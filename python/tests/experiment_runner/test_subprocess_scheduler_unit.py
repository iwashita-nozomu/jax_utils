...
from jax_util.experiment_runner.subprocess_scheduler import (
...
def test_partition_cpu_indices_and_build_worker_slots_cover_edge_cases(
    ...
    monkeypatch.setattr(
        "jax_util.experiment_runner.subprocess_scheduler._available_cpu_indices",
        lambda: [],
    )
...
def test_run_cases_with_subprocess_scheduler_reports_success_and_callbacks(tmp_path: Path) -> None:
