...
- repo 全体レビュー、棚卸し
  ...
  - required review: `project-review` を正本にし、必要なら `comprehensive-review` と `project-health` を併用する
  - subagent: `project_reviewer`、必要なら `docs_researcher`、`worktree_health_reviewer`
