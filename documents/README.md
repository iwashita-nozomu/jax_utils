...
- **[Path A: 初心者オンボーディング](./AGENT_TASK_MAP.md#📦-初心者向けtask-1-10)** — Task 1-10 (1.5-2h)
- **[Path B: 実装者フロー](./AGENT_TASK_MAP.md#💻-実装者向けtask-11-20)** — Task 11-20 (2-3h)
- **[Path C: アーキテクチャ・レビュー](./AGENT_TASK_MAP.md#🎓-テックリード向けtask-21-30)** — Task 21-30 (2.5-3.5h)
- **[Path D: 運用・管理](./AGENT_TASK_MAP.md#🏢-プロジェクト管理向けtask-31-40)** — Task 31-40 (2-3h)
- **[Path E: 自動化 AI](./AGENT_TASK_MAP.md#🤖-aiエージェント向けtask-41-50)** — Task 41-50 (2.5-3h)
...
2. 自分の Path を [🎯 タスクマップ](./AGENT_TASK_MAP.md) から選択
3. **Task 1** から開始
4. 疑問があれば [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) または [✅ 検証レポート](./AGENT_TASK_VALIDATION_REPORT.md) 参照
...
- **[エージェントタスク検証](./AGENT_TASK_VALIDATION_REPORT.md#🎯-リソース不足エリア)** → 実装可能性確認
