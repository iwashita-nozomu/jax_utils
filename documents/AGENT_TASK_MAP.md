...
1. [使い方ガイド](#📌-使い方ガイド)
2. [ユーザー層別タスク一覧](#ユーザー層別タスク一覧)
3. [タスク詳細](#50-タスク詳細)
4. [動線マップ（依存関係）](#動線マップ依存関係)
5. [リソース検証結果](#リソース検証結果)
...
| # | タスク名 | 領域 | 複雑度 | 時間 | 参考 |
|---|---|---|---|---|---|
| 1 | Python 環境セットアップ | 環境設定 | L1 | 10 分 | [QUICK_START.md](./README.md#クイックスタート) |
...
| 9 | よくある質問を検索 | トラブル | L1 | 5 分 | [TROUBLESHOOTING.md](./TROUBLESHOOTING.md#よくある質問) |
...
| # | タスク名 | 領域 | 複雑度 | 時間 | 参考 |
|---|---|---|---|---|---|
| 11 | 新規 Python モジュール作成 | コード実装 | L2 | 20 分 | [FILE_CHECKLIST_OPERATIONS.md](./FILE_CHECKLIST_OPERATIONS.md#チェックリスト2) |
...
| 16 | リント自動修正 | リント | L2 | 5 分 | [ruff check --fix コマンド](#タスク詳細16-リント自動修正) |
| 17 | コミット・プッシュ | レビュー | L2 | 5 分 | [git操作](./BRANCH_SCOPE.md#コミット・プッシュ) |
| 18 | ドキュメント追加 | ドキュメント | L2 | 15 分 | [FILE_CHECKLIST_OPERATIONS.md](./FILE_CHECKLIST_OPERATIONS.md#チェックリスト4) |
| 19 | ブランチのメモ記録 | 知識管理 | L2 | 5 分 | [notes/branches/README.md](../notes/branches/README.md) |
| 20 | CI パス（テスト失敗から回復） | トラブル | L2 | 15 分 | [TROUBLESHOOTING.md - テスト失敗](./TROUBLESHOOTING.md#pytest失敗時) |
...
| 26 | 統合テストの設計 | テスト | L3 | 60 分 | [coding-conventions-testing.md](./coding-conventions-testing.md#統合テスト) |
...
| 32 | ワークツリー削除・クリーンアップ | ワークツリー | L2 | 15 分 | [FILE_CHECKLIST_OPERATIONS.md](./FILE_CHECKLIST_OPERATIONS.md#チェックリスト6) |
| 33 | ワークツリー規約チェック | ワークツリー | L2 | 10 分 | [check_worktree_scopes.sh](../scripts/tools/check_worktree_scopes.sh) |
| 34 | ドキュメント品質チェック | ドキュメント | L2 | 20 分 | [FILE_CHECKLIST_OPERATIONS.md](./FILE_CHECKLIST_OPERATIONS.md#チェックリスト8) |
...
**参考ドキュメント**:
- [root/README.md - クイックスタート](../README.md#-クイックスタート)
...
**次のステップ**: → [Task 2](#【task-2】git-リポジトリ初期化)
...
**次のステップ**: → [Task 3](#【task-3】最初のワークツリー作成)
...
```bash
cd /workspace
bash scripts/setup_worktree.sh "example" "main"
git worktree list
```
...
**次のステップ**: → [Task 4](#【task-4】worktree_scope-作成)
...
**次のステップ**: → [Task 5](#【task-5】最初の-pytest-実行)
...
**参考ドキュメント**:
- [coding-conventions-testing.md - 🚀 クイックリファレンス](./coding-conventions-testing.md#クイックリファレンス)
...
**次のステップ**: → [Task 7](#【task-7】readmemd-ナビゲーション)
...
**参考ドキュメント**:
- [tools/README.md - CI スクリプト実行ガイド](./tools/README.md#🔄-ci-スクリプト実行ガイドscriptsci)
...
**次のステップ**: → [Task 9](#【task-9】よくある質問を検索)
...
**参考ドキュメント**:
- [TROUBLESHOOTING.md](./TROUBLESHOOTING.md#よくある質問)
...
**次のステップ**: → [Task 10](#【task-10】markdown-リント確認)
...
**次のステップ**: → [Task 11](#【task-11】新規-python-モジュール作成) （初心者タスク完了 🎉）
...
**参考ドキュメント**:
- [coding-conventions-python.md - 🚀 クイックスタート](./coding-conventions-python.md#クイックスタート)
...
**次のステップ**: → [Task 14](#【task-14】ユニットテスト作成)
...
**次のステップ**: → [Task 13](#【task-13】jax-コード実装簡単) または [Task 15](#【task-15】型エラー修正)
...
**参考ドキュメント**:
- [coding-conventions-testing.md - 🚀 クイックリファレンス「ユニットテスト作成」行](./coding-conventions-testing.md#クイックリファレンス)
...
**次のステップ**: → [Task 16](#【task-16】リント自動修正)
...
**次のステップ**: → [Task 17](#【task-17】コミットプッシュ)
...
**次のステップ**: → [Task 18](#【task-18】ドキュメント追加) または [Task 23](#【task-23】コードレビュープr-チェック)（レビュー者向け）
...
**参考ドキュメント**:
- [FILE_CHECKLIST_OPERATIONS.md - チェックリスト4](./FILE_CHECKLIST_OPERATIONS.md#チェックリスト4)
...
**次のステップ**: → [Task 19](#【task-19】ブランチのメモ記録)
...
**次のステップ**: → [Task 20](#【task-20】ci-パステスト失敗から回復) または [Task 23](#【task-23】コードレビュープr-チェック)
...
**参考ドキュメント**:
- [tools/README.md - トラブルシューティング](./tools/README.md#トラブルシューティング)
...
**参考**: [coding-conventions-testing.md - 🚀 クイックリファレンス「統合テスト設計」行](./coding-conventions-testing.md#クイックリファレンス)
...
| fix_markdown_*.py | Python | ✅ | 自動修正ツール 3 個 |
| audit_and_fix_links.py | Python | ✅ | リンク監査 |
| find_similar_*.py | Python | ✅ | 重複検出（設計・ドキュメント） |
...
2. **1 時間以内**: Task 1-3 を実行
3. **本日中**: 自分の Path の Task 1-10 を完了
4. **継続**: Path 完了まで進める
