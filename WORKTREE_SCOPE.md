...
- Purpose: `SmolyakIntegrator` の最適化と、`experiments/functional/smolyak_scaling/README.md` を含む実験入口の整理を進める。
...
- [notes/branches/work_smolyak_integrator_mainready_20260404.md](/workspace/notes/branches/work_smolyak_integrator_mainready_20260404.md)
...
- `notes/branches/work_smolyak_integrator_mainready_20260404.md`
...
- Branch summary path: `notes/branches/work_smolyak_integrator_mainready_20260404.md`
- worktree 内でも、最終配置と同じ相対パスで下書きする

## Required Checks Before Commit

- `python3 -m pytest python/tests/functional/test_smolyak.py`
- `PYTHONPATH=python python3 experiments/functional/smolyak_scaling/run_smolyak_scaling.py --platform cpu --dimensions 1:1 --levels 1:1 --dtypes float32 --integration-methods smolyak --execution-variants single --num-repeats 1 --num-accuracy-problems 4`
- `git diff --check`
