...
- 実験コード本体: [experiments/smolyak_experiment](/workspace/experiments/smolyak_experiment)
- 汎用実行基盤: [python/jax_util/experiment_runner](/workspace/python/jax_util/experiment_runner)
...
実際の引数と既定値は [run_smolyak_experiment_simple.py](/workspace/experiments/smolyak_experiment/run_smolyak_experiment_simple.py) を参照する。
